...
if __name__ == '__main__':
    ...
    # Adjusted Batch Size and Learning Rate (try different values here)
    batch_size = 32  # You can try values like 8, 16, 32
    learning_rate = 0.001  # Adjust the learning rate (try values like 0.0001, 0.0005, 0.001)
